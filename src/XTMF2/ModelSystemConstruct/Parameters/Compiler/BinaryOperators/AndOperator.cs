...
/// </summary>
internal sealed class AndOperator : Expression
{
    /// <summary>
    ...
    public AndOperator(Expression lhs, Expression rhs, ReadOnlyMemory<char> expression, int offset) : base(expression, offset)
    {
        _lhs = lhs;
        _rhs = rhs;
    ...
    private static Type[] _SupportedTypes = new[] { typeof(bool) };

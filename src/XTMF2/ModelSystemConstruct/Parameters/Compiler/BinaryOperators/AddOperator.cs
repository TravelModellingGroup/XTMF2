...
/// <summary>
/// This provides the implementation for adding
/// </summary>
internal sealed class AddOperator : Expression
{
    /// <summary>
    ...
    public AddOperator(Expression lhs, Expression rhs, ReadOnlyMemory<char> expression, int offset) : base(expression, offset)
    {
        _lhs = lhs;
        _rhs = rhs;

...
/// </summary>
internal sealed class LessThanOrEqualOperator : Expression
{
    /// <summary>
    ...
    public LessThanOrEqualOperator(Expression lhs, Expression rhs, ReadOnlyMemory<char> expression, int offset) : base(expression, offset)
    {
        _lhs = lhs;
        _rhs = rhs;

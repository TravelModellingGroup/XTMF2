...
/// <summary>
/// This provides the implementation for multiplying
/// </summary>
internal sealed class MultiplyOperator : Expression
{
    /// <summary>
    ...
    public MultiplyOperator(Expression lhs, Expression rhs, ReadOnlyMemory<char> expression, int offset) : base(expression, offset)
    {
        _lhs = lhs;
        _rhs = rhs;
    ...
    private static void TestTypes(Expression lhs, Expression rhs, int offset)
    {
        ...
        {
            throw new CompilerException($"The LHS and RHS of the * operator are not of the same type! LHS = {lhs.Type.FullName}, RHS = {rhs.Type.FullName}", offset);
        }

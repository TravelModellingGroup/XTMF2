...
/// </summary>
internal sealed class LessThanOperator : Expression
{
    /// <summary>
    ...
    public LessThanOperator(Expression lhs, Expression rhs, ReadOnlyMemory<char> expression, int offset) : base(expression, offset)
    {
        _lhs = lhs;
        _rhs = rhs;

...
/// </summary>
internal sealed class NotEqualsOperator : Expression
{
    /// <summary>
    ...
    public NotEqualsOperator(Expression lhs, Expression rhs, ReadOnlyMemory<char> expression, int offset) : base(expression, offset)
    {
        _lhs = lhs;
        _rhs = rhs;
